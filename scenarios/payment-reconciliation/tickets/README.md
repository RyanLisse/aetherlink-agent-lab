...
FIN identifiers are local scenario references, not Jira-assigned keys. Keep the
templates local during this participant exercise; do not create remote issues
or link production systems.
